...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-ae1c522a2bcd7f2a", "locked": true, "schema_version": 3, "solution": false, "task": false}
# ## <font color='orange'>[Exercice 1]</font> Une méthode de déflation pour calculer plusieurs valeurs propres dominantes

# + [markdown] nbgrader={"grade": false, "grade_id": "cell-25b349cbda605e93", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": false, "grade_id": "power_iter", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "power_iter_tests", "locked": true, "points": 1, "schema_version": 3, "solution": false, "task": false}
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-c9618e0c7e895d1d", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": false, "grade_id": "deflation_method", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "deflation_method_tests", "locked": true, "points": 2, "schema_version": 3, "solution": false, "task": false}
# Tests automatiques
N = 200
seed = 2024
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-2b7096f389287011", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
#       ```
#     </details>
# + nbgrader={"grade": false, "grade_id": "legendre", "locked": false, "schema_version": 3, "solution": true, "task": false}
function legendre(n)
    ### BEGIN SOLUTION
    p = Polynomial([-1, 0, 1])
...
# + nbgrader={"grade": true, "grade_id": "legendre_tests", "locked": true, "points": 1, "schema_version": 3, "solution": false, "task": false}
X = Polynomial([0, 1])
for n in 1:5
    @assert (n+1)*legendre(n+1) == (2n+1)*X*legendre(n)-n*legendre(n-1)
end

# + [markdown] nbgrader={"grade": false, "grade_id": "cell-84fc8003305ec45c", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": false, "grade_id": "get_nodes_and_weights", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "get_nodes_and_weights_tests", "locked": true, "points": 1, "schema_version": 3, "solution": false, "task": false}
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-7d8cb5ba773ea661", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": false, "grade_id": "composite_gauss_legendre", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "composite_gauss_legendre_tests", "locked": true, "points": 2, "schema_version": 3, "solution": false, "task": false}
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-8f08122a9c4bcdad", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "plot_legendre_error", "locked": false, "points": 2, "schema_version": 3, "solution": true, "task": false}
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-4a19561ec8ac613f", "locked": true, "schema_version": 3, "solution": false, "task": false}
# ### <font color='orange'>[Exercice 3]</font> Trajectoire d'une masse ponctuelle sur un rail

# + [markdown] nbgrader={"grade": false, "grade_id": "cell-8a547a50ccf6374b", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": false, "grade_id": "cell-e9d4527fa7ace911", "locked": true, "schema_version": 3, "solution": false, "task": false}
const g = 9.81 ;
const m = 0.03 ;
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-2b3d5a8159f80773", "locked": true, "schema_version": 3, "solution": false, "task": false}
# 1. Tracer les courbes $y_{\alpha}(x)$ correspondant à plusieurs valeurs de $\alpha \in \{1, \dotsc, 10\}$ pour $x\in[-1,1]$.

# + nbgrader={"grade": true, "grade_id": "plot_profiles", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
### BEGIN SOLUTION
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-a8301fcbf0a4ebe9", "locked": true, "schema_version": 3, "solution": false, "task": false}
# 2. Écrire la fonction $f$ sous forme d'une fonction Julia `f(u, α)`.

# + nbgrader={"grade": false, "grade_id": "f_u_alpha", "locked": false, "schema_version": 3, "solution": true, "task": false}
function f(u, α)
    ### BEGIN SOLUTION
    x, dx = u
    yp, ypp = x .|> [dy(α), d2y(α)]
...
# + nbgrader={"grade": true, "grade_id": "f_u_alpha_tests", "locked": true, "points": 1, "schema_version": 3, "solution": false, "task": false}
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-ef18dcbc116b067d", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": false, "grade_id": "rk4", "locked": false, "schema_version": 3, "solution": true, "task": false}
function rk4(uₙ, Δ, f)
    ### BEGIN SOLUTION
    k₁ = f(uₙ)
    k₂ = f(uₙ + Δ/2 * k₁)
...
# + nbgrader={"grade": true, "grade_id": "rk4_tests", "locked": true, "points": 1, "schema_version": 3, "solution": false, "task": false}
@assert rk4([0.], 1., u -> [1.]) ≈ [1.0]
@assert rk4([3.,12.], 1., u -> u .* [2.,3.]) ≈ [21.,196.5]

# + [markdown] nbgrader={"grade": false, "grade_id": "cell-1d9afc657548a3b7", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "solve_ode", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-9551dbbc0e31ebb3", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "final_time", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-4bf19352e5b24af2", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "plot_time", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
### BEGIN SOLUTION
plot(LinRange(0.001, 20, 1000), final_time)
vline!([2.55])
### END SOLUTION

# + [markdown] nbgrader={"grade": false, "grade_id": "cell-1abeb30d548bbb1b", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": false, "grade_id": "newton_raphson_dual", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "newton_raphson_dual_tests", "locked": true, "points": 1, "schema_version": 3, "solution": false, "task": false}
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-e7c0348b3375d803", "locked": true, "schema_version": 3, "solution": false, "task": false}
# 8. Déterminer la ou les valeurs de $\alpha$ permettant d'atteindre le point final en $t=0.85s$.

# + nbgrader={"grade": true, "grade_id": "alpha_given_t", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
### BEGIN SOLUTION
...
# + [markdown] nbgrader={"grade": false, "grade_id": "cell-12abfd3820e22d2a", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": false, "grade_id": "alpha_opt", "locked": false, "schema_version": 3, "solution": true, "task": false}
### BEGIN SOLUTION
...
# + nbgrader={"grade": true, "grade_id": "alpha_opt_tests", "locked": true, "points": 2, "schema_version": 3, "solution": false, "task": false}
@assert abs(α_opt-2.677)<1e-3

# + [markdown] nbgrader={"grade": false, "grade_id": "cell-04419576bd3ebddc", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + nbgrader={"grade": true, "grade_id": "animate_sol", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
