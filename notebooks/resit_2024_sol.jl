...
# + [markdown] deletable=false editable=false nbgrader={"cell_type": "markdown", "checksum": "11536394e9ca05b3fe7627e697e8ae4f", "grade": false, "grade_id": "cell-9546f1bdb893cdcd", "locked": true, "schema_version": 3, "solution": false, "task": false}
...
# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "399438db784622c2a59302a326d371b2", "grade": false, "grade_id": "cell-4d638a879ba6f86e", "locked": true, "schema_version": 3, "solution": false, "task": false}
using ForwardDiff
using LaTeXStrings
using LinearAlgebra
using Plots
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "53a972cd519e2a5b9555cdb722e35266", "grade": false, "grade_id": "interp_pde", "locked": false, "schema_version": 3, "solution": true, "task": false}
# Right-hand side
...
# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "794336f1e976ed6fabbc4a8351d3fc99", "grade": true, "grade_id": "cell-e79ffe6285cd8198", "locked": true, "points": 2, "schema_version": 3, "solution": false, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "8df0edb8ea70bb6581037e0c1941f03a", "grade": false, "grade_id": "interp_error", "locked": false, "schema_version": 3, "solution": true, "task": false}
# Exact solution (for comparison purposes)
uₑ(x) = cospi(2*x) - 1
...
# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "c31c4b8d83e4dc0187358814d0ced950", "grade": true, "grade_id": "cell-9764a7b6ad0837c3", "locked": true, "points": 2, "schema_version": 3, "solution": false, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "97daacc40b3e33b0c7588dc5a60db184", "grade": true, "grade_id": "interp_plot", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
# YOUR CODE HERE
throw(ErrorException("No code provided"))
# -
...
# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "c4fc9bdb21f51860a85061679144a681", "grade": false, "grade_id": "cell-7cc040866d32d6b0", "locked": true, "schema_version": 3, "solution": false, "task": false}
κ(u, α) = 1 + α^2 * u^2
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "d0213ec58811a7e45223919f524bc7de", "grade": false, "grade_id": "solve_nonlin", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "3f417d22c2dcfb06e7bf0cac21cb7d06", "grade": true, "grade_id": "cell-68fd71f3ebf99d3e", "locked": true, "points": 2, "schema_version": 3, "solution": false, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "5899b96cfee935b5d4bdae4a537c9471", "grade": false, "grade_id": "solve_poisson", "locked": false, "schema_version": 3, "solution": true, "task": false}
function solve_poisson(N, α)
    # YOUR CODE HERE
    throw(ErrorException("No code provided"))
end

# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "1f188a125d5d773ea0a839f81b393517", "grade": true, "grade_id": "cell-0daaf7cc0874d73d", "locked": true, "points": 1, "schema_version": 3, "solution": false, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "d63c961f8e8873d5d6a48c127871c5fa", "grade": true, "grade_id": "plot_poisson_1", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
α = 30.
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "c9d2ddb08d49a0237c57d88cad4148f9", "grade": true, "grade_id": "plot_poisson_2", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
N = 50
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "1b75523596c27fdcdcff310db89c804d", "grade": false, "grade_id": "mean_temperature", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "6b6dd3f64800ed0fa058391c7f25c8ea", "grade": false, "grade_id": "2", "locked": false, "schema_version": 3, "solution": true, "task": false}
# YOUR CODE HERE
throw(ErrorException("No code provided"))
# -
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "a6bf68c3ea52bf71a4ca1839a07197d6", "grade": false, "grade_id": "newton_raphson", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "6f8cb0202a02d2602bd4e19dabff6f41", "grade": true, "grade_id": "cell-d2e7364ddc277254", "locked": true, "points": 2, "schema_version": 3, "solution": false, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "908ef2507e5f495ee99ddb6ea62f24a9", "grade": true, "grade_id": "get_alpha", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "590fc9619511f69233c02a2647340840", "grade": true, "grade_id": "plot_alpha", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
# YOUR CODE HERE
throw(ErrorException("No code provided"))
# -
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "717bd28f5cd65eb0edf23bd02a2505d5", "grade": false, "grade_id": "V_buoy", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "d27043eccfb0e49d16dee56c0472d52b", "grade": true, "grade_id": "cell-0eef22c644cfc99f", "locked": true, "points": 1, "schema_version": 3, "solution": false, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "489ddec4dd1e7745f5c06399d3501765", "grade": false, "grade_id": "f_ode", "locked": false, "schema_version": 3, "solution": true, "task": false}
# Parameter `A` in the drag force (depends on volume `Vb` of the buoy)
A_total(Vb) = max(A_diver, π*(3Vb/4π))^(4/3)
...
# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "a1f6868e5f13839622500231e2487610", "grade": true, "grade_id": "cell-e119b00105e73c51", "locked": true, "points": 2, "schema_version": 3, "solution": false, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "4ab800cf7768833dbc3097c8558f2281", "grade": false, "grade_id": "rkx", "locked": false, "schema_version": 3, "solution": true, "task": false}
# YOUR CODE HERE
throw(ErrorException("No code provided"))

# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "e874d2949b8d0d3a7a47bf8bf1edacfa", "grade": true, "grade_id": "cell-35dffc49bd8d021b", "locked": true, "points": 1, "schema_version": 3, "solution": false, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "aee13cc888f15b041f4454710150d1b7", "grade": false, "grade_id": "solve_ode", "locked": false, "schema_version": 3, "solution": true, "task": false}
...
# + deletable=false editable=false nbgrader={"cell_type": "code", "checksum": "36a56d8ec96b1a78cd28f2b69b58b2ee", "grade": true, "grade_id": "cell-362b4d008e1484af", "locked": true, "points": 2, "schema_version": 3, "solution": false, "task": false}
...
@assert solve_ode(.01, -10., .1)[1][end] > 4
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "0e5b7eb7d6f81cc4e1d51f1ed2c05f54", "grade": true, "grade_id": "plot_z", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "c503b39de38ff37cae2dc8e268a0227f", "grade": true, "grade_id": "plot_v", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "a785d9cdda06ab2cbc187b1ab98ef48c", "grade": true, "grade_id": "rescue_time", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "85eddcc0c920e0afb11ae920c143e2d2", "grade": true, "grade_id": "plot_rescue_time", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
# YOUR CODE HERE
throw(ErrorException("No code provided"))
# -
...
# + deletable=false nbgrader={"cell_type": "code", "checksum": "44db7d8ed0bfd3e559f1ea095c970a77", "grade": true, "grade_id": "bonus", "locked": false, "points": 1, "schema_version": 3, "solution": true, "task": false}
# YOUR CODE HERE
throw(ErrorException("No code provided"))
